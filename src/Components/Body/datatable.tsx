...
export default function DataTable({
  ...
  const allList = competitionsList.concat(
    playersList,
    clubsList,
    coachesList,
    refereesList
    ...
    <div className="body__table">
        ...
        <ul className="table__title-list">
          ...
          {showCompetitionsTab && (
            <li
              ...
              className={clsx(
                "table__title-items",
                activeId === "competition" && "active"
              )}
              onClick={(e) => {
                handleAcivte("competition");
              }}
            >
              <span className="icon">
                <GiTrophyCup />
          ...
          {showRefereesTab && (
            <li
              className={clsx(
                "table__title-items",
                activeId === "referee" && "active"
              )}
              onClick={(e) => {
                handleAcivte("referee");
              }}
            >
              <span className="icon">
                <GiWhistle />
              </span>
              <span className="text">Referees</span>
      ...
      <div className="table__content">
        ...
        <div className="table__content-page">
          ...
          {activeId === "competition" && (
            <DatatableContent list={competitionsList} />
          )}
